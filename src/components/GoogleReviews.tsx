...
const reviews = [
  {
    ...
    date: "2 weeks ago",
    rating: 5,
    text: "Gayatri Caterers provided exceptional food for our wedding. The Gujarati Thali was a massive hit among all guests. Highly professional team and great hygiene standards.",
    avatar:
  ...
  },
  {
    ...
    date: "1 month ago",
    rating: 5,
    text: "Booked them for my father's 50th birthday. The customized menu was perfect, and the live chaat counter was the highlight of the evening. Will definitely book again!",
    avatar:
  ...
  },
  {
    ...
    date: "3 months ago",
    rating: 5,
    text: "Excellent pure vegetarian catering service. We had strict Jain food requirements, and they handled it perfectly without compromising on taste. The presentation was top-notch.",
    avatar:
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg">
            Read genuine reviews from our happy clients who trusted us with
